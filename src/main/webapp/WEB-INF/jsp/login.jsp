...
<body class="bg-gray-200 flex items-center justify-center h-screen">
    ...
    <h1 class="text-3xl text-center text-gray-700 mb-4">${intestazione}</h1>
    <form action="${pageContext.request.contextPath}/login" method="post" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
        <div class="mb-4">
